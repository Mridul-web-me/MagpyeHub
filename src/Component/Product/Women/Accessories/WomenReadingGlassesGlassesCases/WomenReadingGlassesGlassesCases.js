...
const WomenReadingGlassesGlassesCases = () => {
    ...
    const size = 8;
    const category = 'womenReadingGlassesGlassesCases'
    useEffect(() => {
            ...
            <Container fluid>
                <Row>
                    <h3 style={{
                        ...
                        marginBottom: '20px'
                    }}> Reading Glasses & Glasses Cases</h3>
                    <Col md={3} xs={12}>
...
export default WomenReadingGlassesGlassesCases