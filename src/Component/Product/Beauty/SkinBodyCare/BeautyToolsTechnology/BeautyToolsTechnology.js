...
const BeautyToolsTechnology = () => {
    ...
    const size = 8;
    const category = 'beautyToolsTechnology'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Beauty Tools & Technology</title>
...
export default BeautyToolsTechnology