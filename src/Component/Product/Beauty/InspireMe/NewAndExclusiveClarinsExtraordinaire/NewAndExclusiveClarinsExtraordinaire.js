...
const NewAndExclusiveClarinsExtraordinaire = () => {
    ...
    const size = 8;
    const category = 'NewAndExclusive'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>New & Exclusive: Clarins Eau Extraordinaire</title>
            ...
            <Container fluid>
                <Row>
                    <h3 style={{
                        ...
                        marginBottom: '20px'
                    }}>New & Exclusive: Clarins Eau Extraordinaire</h3>
                    <Col md={3} xs={12}>
                            ...
                            <Accordion.Item eventKey="4">
                                ...
                                <Accordion.Body>
                                    <div className="filterItem">
                                        ...
                                        <Link onClick={() => { filterProduct('NewAndExclusive') }} to="">New & Exclusive: Clarins Eau Extraordinaire</Link><br />
                                    </div>
                                </Accordion.Body>
                            </Accordion.Item>
...
export default NewAndExclusiveClarinsExtraordinaire