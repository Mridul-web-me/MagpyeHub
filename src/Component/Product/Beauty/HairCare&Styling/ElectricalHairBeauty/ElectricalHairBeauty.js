...
const ElectricalHairBeauty = () => {
    ...
    const size = 8;
    const category = 'electricalHairBeauty'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Electrical Hair & Beauty</title>
...
export default ElectricalHairBeauty