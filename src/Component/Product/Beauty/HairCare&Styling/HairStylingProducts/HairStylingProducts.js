...
const HairStylingProducts = () => {
    ...
    const size = 8;
    const category = 'hairStylingProducts'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Hair Styling Products</title>
...
export default HairStylingProducts