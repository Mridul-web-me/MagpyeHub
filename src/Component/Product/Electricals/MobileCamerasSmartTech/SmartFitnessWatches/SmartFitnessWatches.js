...
const SmartFitnessWatches = (props) => {
    ...
    const size = 8;
    const category = 'SmartFitnessWatches'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Smart & Fitness Watches</title>
...
export default SmartFitnessWatches
