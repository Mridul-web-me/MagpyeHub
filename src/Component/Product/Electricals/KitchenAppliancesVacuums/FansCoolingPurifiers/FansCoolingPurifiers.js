...
const FansCoolingPurifiers = (props) => {
    ...
    const size = 8;
    const category = 'FansCoolingPurifiers'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Fans, Cooling & Purifiers</title>
...
export default FansCoolingPurifiers
