...
const PCsDesktopComputers = () => {
    ...
    const size = 8;
    const category = 'PCsDesktopComputers'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>PC's, Desktop Computers</title>
...
export default PCsDesktopComputers
