...
const TVStandsWallMounts = (props) => {
    ...
    const size = 8;
    const category = 'TVStandsWallMounts'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>TV Stands Wall Mounts</title>
...
export default TVStandsWallMounts
