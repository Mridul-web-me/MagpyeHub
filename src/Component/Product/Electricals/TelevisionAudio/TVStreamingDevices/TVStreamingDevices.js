...
const TVStreamingDevices = (props) => {
    ...
    const size = 8;
    const category = 'TVStreamingDevices'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>TV & Streaming Devices</title>
...
export default TVStreamingDevices
