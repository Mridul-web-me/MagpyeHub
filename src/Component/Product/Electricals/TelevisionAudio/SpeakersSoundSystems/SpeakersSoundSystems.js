...
const SpeakersSoundSystems = (props) => {
    ...
    const size = 8;
    const category = 'SpeakersSoundSystems'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Speakers & Sound Systems</title>
...
export default SpeakersSoundSystems
