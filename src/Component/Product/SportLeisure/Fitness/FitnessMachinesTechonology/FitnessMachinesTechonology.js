...
const FitnessMachinesTechonology = (props) => {
    ...
    const size = 8;
    const category = 'FitnessMachinesTechonology'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Fitness & Machines Techonology</title>
            ...
            <Container fluid>
                <Row>
                    <h3 style={{
                        ...
                        marginBottom: '20px'
                    }}>Fitness & Machines Techonology</h3>
                    <Col md={3} xs={12}>
...
export default FitnessMachinesTechonology
