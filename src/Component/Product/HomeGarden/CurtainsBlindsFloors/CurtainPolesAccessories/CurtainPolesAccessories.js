...
const CurtainPolesAccessories = () => {
    ...
    const size = 8;
    const category = 'curtainPolesAccessories'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Curtain Poles & Accessories</title>
...
export default CurtainPolesAccessories