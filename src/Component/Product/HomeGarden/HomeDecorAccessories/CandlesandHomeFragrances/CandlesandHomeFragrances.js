...
const CandlesandHomeFragrances = () => {
    ...
    const size = 8;
    const category = 'candlesAndHomeFragrances'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Candles and Home Fragrances</title>
            ...
            <Container fluid>
                <Row>
                    <h3 style={{
                        ...
                        marginBottom: '20px'
                    }}>Candles and Home Fragrances</h3>
                    <Col md={3} xs={12}>
...
export default CandlesandHomeFragrances
