...
const FoodProcessorsMixersBlendersJuicers = () => {
    ...
    const size = 8;
    const category = 'foodProcessorsMixersBlendersJuicers'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Food Processors & Mixer Blenders</title>
            ...
            <Container fluid>
                <Row>
                    <h3 style={{
                        ...
                        margin: '20px 0'
                    }}>Food Processors & Mixer Blenders</h3>
                    <Col md={3} xs={12}>
...
export default FoodProcessorsMixersBlendersJuicers
