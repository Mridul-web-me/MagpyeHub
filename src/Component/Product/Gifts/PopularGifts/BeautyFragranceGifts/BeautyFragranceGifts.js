...
const BeautyFragranceGifts = (props) => {
    ...
    const size = 8;
    const category = 'BeautyFragranceGifts'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Beauty Fragrance & Gifts</title>
...
export default BeautyFragranceGifts
