...
const ViewAllGiftFoodDrink = () => {
    ...
    const size = 8;
    const category = 'ViewAllGiftFoodDrink'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>View All Gift Food & Drink</title>
...
export default ViewAllGiftFoodDrink