...
const GiftCardsEGiftCards = () => {
    ...
    const size = 8;
    const category = 'GiftCardsEGiftCards'
    useEffect(() => {
    ...
    return (
        <div>
            <Helmet>
                <title>Gift Cards & E-Gift Cards</title>
...
export default GiftCardsEGiftCards