...
const KidsPyjamasNightwear = () => {
    ...
    const size = 8;
    const category = 'kidspyjamasNightwear'
    useEffect(() => {
...
export default KidsPyjamasNightwear